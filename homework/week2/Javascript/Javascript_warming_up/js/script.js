...
for (var i = 0; i < list.length; i++) {
	ApplePie.ingredients.push(list[i].textContent);
}
...
var pie = document.getElementsByTagName("img")[0]
...
pie.addEventListener("click", hello);
...
var transform = createTransform([0, 10], [10, 30]);
console.log(transform(5)); //should return 15!!
